 ...
 * on 2017-07-25 at 19:06:10 UTC 
 * Modify at your own risk.
 */

package app.sunshine.com.example.android.builditbigger.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getLibJokes".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetLibJokes#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetLibJokes getLibJokes() throws java.io.IOException {
    GetLibJokes result = new GetLibJokes();
    initialize(result);
    return result;
  }

  public class GetLibJokes extends MyApiRequest<app.sunshine.com.example.android.builditbigger.myApi.model.MyBean> {

    private static final String REST_PATH = "GetLibJokes";

    /**
     * Create a request for the method "getLibJokes".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link GetLibJokes#execute()} method to invoke the remote operation. <p>
     * {@link
     * GetLibJokes#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetLibJokes() {
      super(MyApi.this, "POST", REST_PATH, null, app.sunshine.com.example.android.builditbigger.myApi.model.MyBean.class);
    }

    @Override
    public GetLibJokes setAlt(java.lang.String alt) {
      return (GetLibJokes) super.setAlt(alt);
    }

    @Override
    public GetLibJokes setFields(java.lang.String fields) {
      return (GetLibJokes) super.setFields(fields);
    }

    @Override
    public GetLibJokes setKey(java.lang.String key) {
      return (GetLibJokes) super.setKey(key);
    }

    @Override
    public GetLibJokes setOauthToken(java.lang.String oauthToken) {
      return (GetLibJokes) super.setOauthToken(oauthToken);
    }

    @Override
    public GetLibJokes setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetLibJokes) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetLibJokes setQuotaUser(java.lang.String quotaUser) {
      return (GetLibJokes) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetLibJokes setUserIp(java.lang.String userIp) {
      return (GetLibJokes) super.setUserIp(userIp);
    }

    @Override
    public GetLibJokes set(String parameterName, Object value) {
      return (GetLibJokes) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<app.sunshine.com.example.android.builditbigger.myApi.model.MyBean> {
